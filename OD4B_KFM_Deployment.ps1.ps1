...
$GivenTenantID = '0a65cb1e-37d5-41ff-980a-647d9d0e4f0b'
$OutputPath = $OutputPath = (join-path ([environment]::GetFolderPath('Desktop')) "OD4B_KFM_${env:computername}_${env:username}_$(get-date -f dd-MM-yyyy-hhmm).txt")
$PolicyState3 = ''
$PolicyState4 = ''
